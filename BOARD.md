...
Dual-runtime named. Claude/Grok stay the control plane. Waiting on a DeepSeek or Qwen key to cut the first writer envelope.
...
| F2 | landing | AGENTS.md §1 and §5 | Name the product paragraph and never-move rules |
